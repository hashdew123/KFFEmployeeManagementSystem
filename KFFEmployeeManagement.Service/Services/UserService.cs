...
namespace KFFEmployeeManagement.Service.Services
{
    public class UserService : IUserService
    {
        ...
        //public UserService(IUnitOfWork unitOfWork, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        ...
        public async Task<string> UserRegisterAsync(UserRegisterModel model)
        {
            var user = new User
            {
        ...
        //{
        //    return _unitOfWork.Users.GetAll().Select(b => new UserDTO()
        //    {
        //        Password = b.PasswordHash,
        //        UserName = b.UserName,
        //        Role = new RoleDTO()
        //        {
        //            RoleType = b.Role.RoleType
        //        }
        //    }).ToList();
        //}
    }
